...
|  数组长度  |  68   | 374  | 3434  | 34034 | 
|  ---- |  ----  | ----  |----  |----  |
| 提取变量后 | 0.03s  | 0.12s | 0.88s | 41.98s | 
...
|  数组长度  |  68   | 374  | 3434  | 34034 | 
|  ---- |  ----  | ----  |----  |----  |
| 提取变量后 | 0.02s  | 0.07s | 0.56s | 34.12s | 
...
|  数组长度  |  68   | 374  | 3434  | 34034 | 
|  ---- |  ----  | ----  |----  |----  |
| 提取变量后 | 0.02s  | 0.06s | 0.52s | 27.82s | 
![](../image/js-for/20220530-214850@2x.png)

当数组长度为34034时，执行耗时已经进入30s以内
...
整体上还是有17s 的差值，所以从数据上也可以印证for循环要比map的性能更高
...
|  ---- |  ----  | ----  |----  |----  |----  |----  |----  |----  |----  |----  |
| 优化前 | 0.349s  | 0.114s |  0.135s | 0.267s| 0.076s|  0.141s| 0.115s |  0.082s |0.073s | 0.151s|
